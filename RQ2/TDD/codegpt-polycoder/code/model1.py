...
class Model(nn.Module):   
    def __init__(self, codegpt, polycoder, config,tokenizer,args):
    ...
    def forward(self, input_ids=None,attention_mask=None,labels=None): 
        # ===== BERT =====
        codegpt_outputs = self.codegpt(input_ids=input_ids,attention_mask=attention_mask)[0]   # (B, L, 768)

        # ===== Adapter（对齐）=====
        adapted = self.adapter(codegpt_outputs) + codegpt_outputs 
